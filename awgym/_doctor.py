...
interesting failures live BETWEEN them. "awgym is installed" is not the useful
fact -- "awgym is installed and the thing it pairs with is not" is. This reports
...
PAIRS_WITH = ['adk', 'awfocus', 'awgit', 'awgraph', 'awm', 'awrelay', 'awrun']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awgym needs at runtime, and a
